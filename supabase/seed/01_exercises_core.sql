...
insert into public.exercises (id, name_ko, name_en, category, equipment, station_type) values
  ('e0000000-0000-0000-0000-000000000001', '스키에르그',              'SkiErg',            'conditioning', array['skierg'],   'station_1'),
  ('e0000000-0000-0000-0000-000000000002', '슬레드 푸시',             'Sled Push',           'strength',     array['sled'],     'station_2'),
  ('e0000000-0000-0000-0000-000000000003', '슬레드 풀',               'Sled Pull',           'strength',     array['sled'],     'station_3'),
  ('e0000000-0000-0000-0000-000000000004', '버피 브로드점프',         'Burpee Broad Jumps',  'conditioning', array[]::text[],   'station_4'),
  ('e0000000-0000-0000-0000-000000000005', '로잉',                    'Rowing',            'conditioning', array['rower'],    'station_5'),
