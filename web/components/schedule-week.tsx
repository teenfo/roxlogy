        ...
        const body = (
          ...
          >
            ...
            <div className="border-r border-line-mid pr-3 text-center">
              ...
              <p
                className={`tabular text-2xl font-extrabold leading-tight ${
                  d.isToday ? "text-accent-ink" : rest ? "text-muted" : ""
                }`}
              >
                {d.dayOfMonth}
              </p>
              {d.isToday && (
                <span className="mt-0.5 inline-block rounded-full bg-accent px-1.5 text-[10px] font-extrabold text-on-accent">
                  {t("schedule.today")}
                </span>
              )}
            </div>
            ...
            <div className="flex shrink-0 items-center gap-2.5 max-md:col-span-2 max-md:justify-end">
              ...
              {d.isToday && !rest && (
                <span className="flex h-9 items-center rounded-lg bg-accent px-3.5 text-[13px] font-extrabold text-on-accent">
