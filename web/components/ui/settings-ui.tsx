...
export function InitialAvatar({
  ...
  return (
    <span
      aria-hidden
      className="flex shrink-0 items-center justify-center rounded-full bg-accent font-extrabold text-on-accent"
...
export const btnPrimary =
  "flex h-10 shrink-0 items-center justify-center rounded-lg bg-accent px-4 text-sm font-extrabold text-on-accent transition hover:brightness-110 disabled:opacity-40";
...
export const btnAccentGhost =
  "flex h-[38px] shrink-0 items-center justify-center rounded-lg border border-line-accent bg-highlight px-3.5 text-[13px] font-bold text-accent-ink transition hover:brightness-125 disabled:opacity-40";
