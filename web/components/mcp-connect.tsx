    ...
    <>
      <div className="border-b border-line px-[22px] py-[18px] max-md:px-4">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {write === true ? (
            <span className="rounded-[5px] border border-line-accent bg-highlight px-2 py-[3px] text-xs font-bold text-accent-ink">
              {t("mcp.writeOn")}
            </span>
          ) : write === false ? (
          ...
          <div className="rounded-[10px] border border-line-soft bg-inset p-3.5">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="ml-auto flex h-8 shrink-0 items-center rounded-lg bg-accent px-3 text-[13px] font-extrabold text-on-accent transition hover:brightness-110"
              >
        ...
        {notice && (
          <p
            ...
            className={`text-xs font-semibold ${
              notice.kind === "err" ? "text-danger" : "text-accent-ink"
            }`}
          >
            {notice.text}
          </p>
