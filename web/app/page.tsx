...
const ctaPrimary =
  "flex h-[52px] items-center justify-center rounded-[10px] bg-accent px-7 text-base font-extrabold text-accent-foreground transition hover:brightness-95";
const ctaGhost =
      ...
      <header className="sticky top-0 z-40 border-b border-line-soft bg-[color-mix(in_srgb,var(--page)_85%,transparent)] backdrop-blur-md">
        <div className="mx-auto flex h-[60px] max-w-[1120px] items-center justify-between gap-3 px-6 max-md:px-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <Link
              href="/signup"
              className="flex h-9 items-center rounded-lg bg-accent px-4 text-[13px] font-extrabold text-accent-foreground transition hover:brightness-95"
            >
              {t("landing.startCta")}
            </Link>
          </div>
        ...
        <div className="relative mx-auto grid w-full max-w-[1120px] items-center gap-14 px-6 pb-[72px] pt-24 max-md:gap-8 max-md:px-5 max-md:pb-10 max-md:pt-14 md:grid-cols-[1.1fr_0.9fr]">
          <div className="flex flex-col gap-6">
            <h1 className="text-[clamp(2.375rem,5.2vw,3.75rem)] font-black leading-[1.05] tracking-[-0.03em] [text-wrap:balance] [word-break:keep-all]">
              {t("landing.h1a")}{" "}
              <span className="text-gold">{t("landing.h1b")}</span>{" "}
              {t("landing.h1c")}
            </h1>
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-2.5 text-sm font-semibold text-gold">
          ...
          <div className="flex flex-col gap-[18px] rounded-[18px] border border-line-mid bg-card p-[22px] shadow-[var(--shadow-hero)]">
            ...
            <div className="flex flex-wrap items-end justify-between gap-3">
              ...
              <div className="text-right">
                <p className="tabular text-[40px] font-extrabold leading-none tracking-[-0.02em] text-gold max-md:text-[32px]">
                  {sec(demo.finish)}
                </p>
      ...
      <footer className="border-t border-line-soft">
        <div className="mx-auto flex w-full max-w-[1120px] flex-wrap items-center justify-between gap-x-6 gap-y-3 px-6 py-6 text-[13px] text-muted max-md:flex-col max-md:items-start max-md:px-5">
          <span className="flex items-center gap-2">
            <Image src="/roxlogy-appicon.svg" alt="" width={20} height={20} />
